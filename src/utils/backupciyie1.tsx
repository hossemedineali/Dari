...
export const cities: MyType  ={
    //A
   'Ariana':[{label:'Ariana',postion:[36.860200,10.190500]},{value:'Ettadhamen-Mnihla',label: 'Ettadhamen-Mnihla'}, {value:'Kalàt el-Andalous',label:'Kalàt el-Andalous'},{value:'La Soukra',label:'La Soukra'},{value:'Raoued',label:'Raoued'}, {value:'Sidi Thabet',label:'Sidi Thabet'}],
    //B
