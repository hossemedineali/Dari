...
const UserIcon = () => {
    ...
    <div onClick={()=>setshowMenu(!showMenu)}  className="mr-2 w-full h-full">
                ...
                <motion.div
                            ...
                            className="w-40 top-14 right-2 px-2 bg-white justify-center align-middle content-center absolute flex flex-col">
