...
const AuthWrapper = () => {
    ...
    <div
     ...
     className="  absolute mt-2 mb-4 top-0   w-full  flex justify-center text-center  backdrop-sepia z-20">
        <div className="  p-4  bg-white   shadow-2xl h-full border rounded-lg   flex  top-24 justify-center   md:m-0  w-4/5 z-30 md:w-96  text-center ">
            <svg 
