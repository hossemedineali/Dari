...
const Searchwrapper = () => {
    ...
    return ( 
        <div className="relative   lg:w-3/5 md:w-4/6  w-full item-center bg-traansparent  h-40 py-4 md:px-4  rounded-2xl mb-4   ">
           ...
           <h3 onClick={()=>mode.setmode('Buy')} id='Buy' className={`${mode.mode=='Buy'?'border-red':'border-transparent'} text-center py-2 border-b-2 transition ease-in-out duration-1150 cursor-pointer` } >Buy</h3>
