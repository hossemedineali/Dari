...
const SearchInput:React.FC = () => {
    ...
    return ( <div className=" w-full bg-black mt-4">
        ...
        <div className=" flex  relative gap-4 bg-white border-0 px-4">
        ...
        <input onFocus={handelfocus} className="outline-0 w-full mr-auto" placeholder="Type place "/>
